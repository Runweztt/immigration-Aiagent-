# CLAUDE.md - Operational Directives and Coding Conventions

This document outlines the rules, conventions, and operational guidelines for me, the Claude AI assistant, while working on this project.
